...
- New Feature: Sign [BIP-322](https://github.com/bitcoin/bips/blob/master/bip-0322.mediawiki) Proof of Reserves transactions.
...
- New Feature: Nuke Device, purges all sensitive data and make COLDCARD into e-waste.
